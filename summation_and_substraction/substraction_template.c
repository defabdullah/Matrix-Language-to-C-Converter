...
double **matrixSubstraction( double **matrix1, double **matrix2, int row, int column){
    double **newMatrix;
...
int main() {
    ...
    double **resultMatrix=matrixSubstraction(firstMatrix,secondMatrix,2,2);

    printMatrix(row,column,resultMatrix);
    printf("\n%f",scalarSubstraction(3,7));
